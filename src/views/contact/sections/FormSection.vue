    ...
    <div
        ...
        <div class="w-full md:w-1/2 space-y-8 md:space-y-12 lg:space-y-[60px]">
            <div class="w-full space-y-4 md:space-y-6 lg:space-y-8">
                <TitleSection :text="'Kirim Pesan'" />
                <TextSection>We’re here to help with any questions or feedback about UI Wiki</TextSection>
            </div>
            ...
            <div
                ...
                <div class="w-full">
                    <button class="w-full bg-primary hover:bg-secondary py-3 text-white text-[12px] md:text-[14px] lg:text-[18px] rounded-full">Kirim</button>
                </div>
            </div>
        </div>
    </div>
