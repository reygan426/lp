...
<template>
    <div
        class="h-[240px] md:h-[280px] lg:h-[360px] rounded-[8px] md:rounded-[16px] lg:rounded-[24px] p-7 lg:p-7 relative group hover:-translate-y-3 transition duration-500">
        ...
        <div class="absolute bottom-0 right-0 bg-[#E6EFF7] border-2 border-white p-4 rounded-full overflow-hidden group">
            <img :src="Arrow" alt=""
